...
class TestSum(unittest.TestCase):
    ...
    def test_un_pack(self):
        ...
        self.assertEqual(mp, list(sorted(state1['newPanel']['my_pieces'])), "test_un_pack mp != rmp")
        self.assertEqual(op, list(sorted(state1['newPanel']['opponents_pieces'])), "test_un_pack op != rop")
